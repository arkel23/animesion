...
def save_checkpoints(args, model, epoch, curr_acc, top_acc, best_epoch_acc,
    ...
    # save if val loss is lower than current lowest and after mask warmup
    no_epochs_wu = args.mask_wu_percent * args.no_epochs
    if curr_val_loss < lowest_loss and epoch > no_epochs_wu:
